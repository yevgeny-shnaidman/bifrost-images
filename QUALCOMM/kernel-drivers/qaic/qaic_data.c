...
#ifdef _QBP_INCLUDE_HAS_DRM_PRIME
#include <drm/drm_prime.h>
#endif
#ifdef _QBP_INCLUDE_HAS_DRM_PRINT
...
#ifdef _QBP_HAS_INCLUSIVE_MAX_ORDER
...
#ifndef _QBP_ALT_DRM_GEM_OBJ_FUNCS
...
#ifndef _QBP_ALT_DRM_GEM_OBJ_MMAP_FUNC
...
int qaic_create_bo_ioctl(struct drm_device *dev, void *data, struct drm_file *file_priv)
{
	...
	if (ret) {
		trace_qaic_create_bo(usr->qddev, "Failed to get mmap offset.", ret);
		goto free_bo;
	}
...
#ifdef _QBP_HAS_DRM_GEM_OBJ_DMA_RESV
